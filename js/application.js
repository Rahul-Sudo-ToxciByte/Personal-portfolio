!(function (t) {
    ...
    var r = t("html, body"),
      ...
      a = {
        isExternal: function (t) {
          ...
          return (
            ("string" == typeof i[1] &&
              i[1].length > 0 &&
              i[1].toLowerCase() !== e.location.protocol) ||
            ("string" == typeof i[2] &&
              i[2].length > 0 &&
              i[2].replace(
                new RegExp(
        ...
        shouldLoadAnchor: function (t, e, i) {
          ...
          return !(
            ...
            t.is(e) ||
            t.prop("target") ||
            (typeof i !== n && "" !== i && t.prop("href").search(i) === -1)
          );
        },
        ...
        triggerAllAnimationEndEvent: function (e, i) {
          ...
          var n = 0,
            ...
            u = function (i) {
              t(i.delegateTarget).is(e) &&
                (i.stopPropagation(), n--, 0 === n && e.trigger(o));
            };
          e.on(r, l),
            e.on(s, u),
      ...
      u = function (o, l) {
        var u = t(o),
          ...
          R = function (t) {
            (t = t || !1),
              t && p.hasOwnProperty(t) ? delete p[t] : (p = {}),
              (u.data("smoothState").cache = p);
          },
          g = function (e, i) {
            i = i || t.noop;
            var n = a.translate(e);
            if (
              ((p = a.clearIfOverCapacity(p, l.cacheLength)),
              !p.hasOwnProperty(n.url) || "undefined" != typeof n.data)
            ) {
              p[n.url] = {
                status: "fetching",
              };
          ...
          v = function (n) {
            ...
            a.length
              ? ((i.title = p[n].title),
                (u.data("smoothState").href = n),
                l.loadingClass && r.removeClass(l.loadingClass),
                l.onReady.render(u, a),
                u.one("ss.onReadyEnd", function () {
                  (f = !1), l.onAfter(u, a), l.scroll && _(), O(u);
                }),
          ...
          y = function (t, i, n) {
            ...
            var c = !1,
              ...
              m = {
                loaded: function () {
                  ...
                  f && c
                    ...
                    i &&
                      ...
                      (p[o.url].state = d),
                      e.history.pushState(d, p[o.url].title, o.url)),
                    f && !n && R(o.url);
                },
                fetching: function () {
                  c ||
                ...
                error: function () {
                  l.debug && s
                    ? s.log("There was an error loading: " + o.url)
                    : (e.location = o.url);
                },
              };
            p.hasOwnProperty(o.url) || g(o),
              l.onStart.render(u),
              e.setTimeout(function () {
          ...
          x = function (e) {
            var i,
              n = t(e.currentTarget);
            a.shouldLoadAnchor(n, l.blacklist, l.hrefRegex) &&
              !f &&
              (e.stopPropagation(),
              (i = a.translate(n.prop("href"))),
              (i = l.alterRequest(i)),
              g(i));
          },
          w = function (e) {
            ...
            if (
              !e.metaKey &&
              !e.ctrlKey &&
              a.shouldLoadAnchor(i, l.blacklist, l.hrefRegex) &&
            ...
            if (
              ...
              (f = !0),
                ...
                "get" === r.type.toLowerCase() &&
                  (r.url = r.url + "?" + r.data),
                l.onBefore(i, u),
                y(r, n, l.allowFormCaching);
            }
          },
          T = 0,
          z = function () {
            var t = null === l.repeatDelay,
              e = parseInt(Date.now()) > T;
            return !(t || e);
          },
          P = function () {
        ...
        return (
          ...
          null === e.history.state
            ? ((d = l.alterChangeState(
              ...
              e.history.replaceState(d, i.title, m))
            : (d = {}),
          a.storePageIn(p, m, i.documentElement.outerHTML, h, d),
  ...
  !(function (t, e, i) {
    ...
    function r() {
      ...
      for (var l in h)
        if (h.hasOwnProperty(l)) {
          ...
          for (
            r = n(e.fn, "function") ? e.fn() : e.fn, s = 0;
            s < t.length;
            s++
          )
            (o = t[s]),
              ...
              1 === a.length
                ? (f[a[0]] = r)
                : (!f[a[0]] ||
                    f[a[0]] instanceof Boolean ||
                    (f[a[0]] = new Boolean(f[a[0]])),
                  (f[a[0]][a[1]] = r)),
              u.push((r ? "" : "no-") + a.join("-"));
        }
    }
    ...
    function l(t, i, n, r) {
      ...
      if (parseInt(n, 10))
        for (; n--; )
          (u = o("div")), (u.id = r ? r[n] : c + (n + 1)), f.appendChild(u);
      return (
        (s = o("style")),
        (s.type = "text/css"),
        (s.id = "s" + c),
  ...
  !(function (t, e) {
    ...
    if (!n.TweenLite) {
      var r,
        ...
        R = function (r, s, o, a) {
          ...
          (this.check = function (h) {
            for (var c, f, p, d, g, _ = s.length, v = _; --_ > -1; )
              (c = m[s[_]] || new R(s[_], [])).gsClass
                ? ((l[_] = c.gsClass), v--)
                : h && c.sc.push(this);
            if (0 === v && o) {
              if (
                ...
                (p = f.pop()),
                (d = u(f.join("."))[p] = this.gsClass = o.apply(o, l)),
                a)
              )
                if (
                  ((n[p] = d),
      ...
      var v = [0, 0, 1, 1],
        ...
        b = (x.register = function (t, e, i, n) {
          for (
            ...
            for (
              s = l[u],
                r = n ? _("easing." + s, null, !0) : h.easing[s] || {},
                o = c.length;
              --o > -1;
      ...
      for (
        ...
        (o = r[s] + ",Power" + s),
          b(new x(null, null, 1, s), o, "easeOut", !0),
          b(
            new x(null, null, 2, s),
            o,
            "easeIn" + (0 === s ? ",easeNone" : "")
          ),
          b(new x(null, null, 3, s), o, "easeInOut");
      ...
      var z = t.requestAnimationFrame,
        ...
        k = O();
      for (r = ["ms", "moz", "webkit", "o"], s = r.length; --s > -1 && !z; )
        (z = t[r[s] + "RequestAnimationFrame"]),
          (P =
      ...
      (a = C.ticker = new h.Ticker()),
        ...
        (o._paused = !1);
      var S = function () {
        l && O() - k > 2e3 && a.wake(), setTimeout(S, 2e3);
      };
      S(),
        (o.play = function (t, e) {
          ...
          if (this._timeline) {
            ...
            this._gc && this._enabled(!0, !1),
              (this._totalTime !== t || 0 === this._duration) &&
                (F.length && Z(), this.render(t, e, !1), F.length && Z());
          }
          return this;
        }),
      ...
      var F = [],
              ...
              ("function" === c &&
                ...
                ((u =
                  ...
                  "function" != typeof t["get" + e.substr(3)]
                    ...
                    : "get" + e.substr(3)),
                (p.s = h = o ? t[u](o) : t[u]())),
              "string" == typeof h && (o || isNaN(h))
                ? ((p.fp = o),
                  (l = X(h, n, a || E.defaultStringFilter, p)),
                  (p = {
                    t: l,
                    p: "setRatio",
                    s: 0,
                ...
                : f ||
                  ((p.s = parseFloat(h)), (p.c = parseFloat(n) - p.s || 0))),
            p.c
        ...
        W = (C._rootFramesTimeline = new A()),
        H = (C._rootTimeline = new A()),
        Q = 30,
      ...
      (H._startTime = a.time),
        ...
        (H._active = W._active = !0),
        setTimeout(Z, 1),
        (C._updateRoot = E.render =
          function () {
            var t, e, i;
            if (
              (F.length && Z(),
              H.render((a.time - H._startTime) * H._timeScale, !1, !1),
              W.render((a.frame - W._startTime) * W._timeScale, !1, !1),
              F.length && Z(),
              a.frame >= Q)
            ) {
              Q = a.frame + (parseInt(E.autoSleep, 10) || 120);
              for (i in B) {
      ...
      var $ = function (t, e, i) {
        ...
        tt = function (t, e, i) {
          ...
          return (
            ...
            s > e
              ? s - e
              : (i && s === e) || (!t._initted && 2 * c > s - e)
              ? c
              : (s += t.totalDuration() / t._timeScale / r) > e + c
              ? 0
              : s - e - c
          );
        };
        ...
        (o._initProps = function (e, i, n, r) {
          ...
          for (s in this.vars)
            if (((h = this.vars[s]), q[s]))
              ...
              V[s] &&
              (l = new V[s]())._onInitTween(e, this.vars[s], this)
            ) {
              for (
                this._firstPT = u =
                  {
          ...
          if (t >= l - 1e-7)
            (this._totalTime = this._time = l),
              ...
              0 === l &&
                ...
                (0 > u ||
                  (0 >= t && t >= -1e-7) ||
                  (u === c && "isPause" !== this.data)) &&
                  u !== t &&
                  ((i = !0), u > c && (r = "onReverseComplete")),
    ...
    function (t, e) {
      ...
      var h,
        ...
        B = (function () {
          ...
          return (
            ...
            (d = f && Number(V.substr(V.indexOf("Version/") + 8, 1)) < 6),
          ...
          return B || "opacity" !== e
            ? (!n && t.style[e]
                ...
                ? (s =
                    ...
                    i.getPropertyValue(e.replace(z, "-$1").toLowerCase()))
        ...
        $ = (Y.convertToPixels = function (t, i, n, r, s) {
          ...
          if (
            ...
            c.appendChild(X),
              (a = parseFloat(X[h ? "offsetWidth" : "offsetHeight"])),
              c.removeChild(X),
              h &&
                "%" === r &&
                o.cacheWidths !== !1 &&
        ...
        K = (Y.calculateOffset = function (t, e, i) {
          ...
          var n = "left" === e ? "Left" : "Top",
            r = Z(t, "margin" + n, i);
          return (
            t["offset" + n] - ($(t, e, parseFloat(r), r.replace(y, "")) || 0)
          );
        }),
        J = function (t, e) {
          var i,
          ...
          if ((e = e || Q(t, null)))
            if ((i = e.length))
              for (; --i > -1; )
                (r = e[i]),
                  (-1 === r.indexOf("-transform") || Pt === r) &&
                    (s[r.replace(P, k)] = e.getPropertyValue(r));
            else
              for (i in e)
                (-1 === i.indexOf("Transform") || zt === i) && (s[i] = e[i]);
        ...
        nt = function (t, e, i) {
          ...
          for (i = i || Q(t, null); --s > -1; )
            (n -= parseFloat(Z(t, "padding" + r[s], i, !0)) || 0),
              ...
              if (
                ...
                if (((i = f = t.match(R)), e)) {
                  ...
                  (o = (Number(i[0]) % 360) / 360),
                    ...
                    (i[1] = ut(o, n, r)),
                    (i[2] = ut(o - 1 / 3, n, r));
              else i = t.match(R) || lt.transparent;
              (i[0] = Number(i[0])),
                (i[1] = Number(i[1])),
                (i[2] = Number(i[2])),
      ...
      var pt = function (t, e, i, n) {
        ...
        _t = (o.parseComplex = function (t, e, i, n, r, s, a, l, u, c) {
          (i = i || s || ""),
            (a = new Rt(t, e, 0, 0, a, c ? 2 : 1, null, !1, l, i, n)),
            (n += ""),
            r &&
              ft.test(n + i) &&
          ...
          for (
            (-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) &&
              ((O = O.join(" ").replace(E, ", ").split(" ")),
              (k = k.join(" ").replace(E, ", ").split(" ")),
              (C = O.length)),
            ...
            if (((m = O[f]), (_ = k[f]), (x = parseFloat(m)), x || 0 === x))
              a.appendXtra(
                "",
                x,
                st(_, x),
              ...
              (z = _.indexOf(")") + 1),
                ...
                (m = ht(m, P)),
                (_ = ht(_, P)),
                (w = m.length + _.length > 6),
                w && !B && 0 === _[3]
                  ? ((a["xs" + a.l] += a.l ? " transparent" : "transparent"),
                    (a.e = a.e.split(k[f]).join("transparent")))
                  : (B || (w = !1),
                    P
                      ? a
                          .appendXtra(
                      ...
                      : a
                          ...
                          .appendXtra("", m[1], _[1] - m[1], ",", !0)
                          .appendXtra("", m[2], _[2] - m[2], w ? "," : z, !0),
                    w &&
                      ((m = m.length < 4 ? 1 : m[3]),
                      a.appendXtra(
                        "",
          ...
          if (-1 !== n.indexOf("=") && a.data) {
            for (z = a.xs0 + a.data.s, f = 1; f < a.l; f++)
              z += a["xs" + f] + a.data["xn" + f];
            a.e = z + a["xs" + f];
          }
          return a.l || ((a.type = -1), (a.xs0 = a.e)), a.xfirst || a;
        }),
        vt = 9;
      for (u = Rt.prototype, u.l = u.pr = 0; --vt > 0; )
        (u["xn" + vt] = 0), (u["xs" + vt] = "");
      (u.xs0 = ""),
        (u._next =
          u._prev =
      ...
      var yt = function (t, e) {
          (e = e || {}),
            ...
            (this.format =
              e.formatter ||
              pt(e.defaultValue, e.color, e.collapsible, e.multi)),
      ...
      var bt,
        ...
        zt = H("transform"),
        Pt = G + "transform",
        Ot = H("transformOrigin"),
        kt = null !== H("perspective"),
        Ct = (Y.Transform = function () {
          (this.perspective = parseFloat(o.defaultTransformPerspective) || 0),
            (this.force3D =
              !(o.defaultForce3D === !1 || !kt) &&
        ...
        Mt = (function () {
          ...
          return (
            L.createElementNS &&
              ...
              (e.style[Ot] = "50% 50%"),
              (e.style[zt] = "scaleX(0.5)"),
              (n = i === e.getBoundingClientRect().width && !(p && kt)),
              Et.removeChild(t)),
            n
          );
        })(),
        Nt = function (t, e, i, n, r, s) {
          ...
          x && ((v = x.xOrigin), (y = x.yOrigin)),
            ...
            n &&
              ...
              (g = w[5]),
              (_ = f * m - p * d),
              (l = h * (m / _) + c * (-d / _) + (d * g - m * R) / _),
              (u = h * (-p / _) + c * (f / _) - (f * g - p * R) / _),
              (h = i.xOrigin = a[0] = l),
              (c = i.yOrigin = a[1] = u)),
            x &&
        ...
        jt = function (t, e) {
          ...
          if (
            (zt
              ? (n = Z(t, Pt, null, !0))
              : t.currentStyle &&
                ((n = t.currentStyle.filter.match(S)),
                (n =
                  n && 4 === n.length
                    ? [
                        n[0].substr(4),
            ...
            i &&
              ...
              (n = Z(t, Pt, null, !0)),
              (i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n),
              s ? (h.display = s) : a && Bt(h, "display"),
              o && Et.removeChild(t)),
            (l.svg || (t.getBBox && It(t))) &&
              (i &&
            ...
            return Lt;
          for (r = (n || "").match(R) || [], vt = r.length; --vt > -1; )
            (s = Number(r[vt])),
              (r[vt] = (o = s - (s |= 0))
                ? ((o * u + (0 > o ? -0.5 : 0.5)) | 0) / u + s
                : s);
          return e && r.length > 6 ? [r[0], r[1], r[4], r[5], r[12], r[13]] : r;
        },
        Xt = (Y.getTransform = function (t, i, n, r) {
          ...
          var s,
            ...
            h,
            c,
            f = n ? t._gsTransform || new Ct() : new Ct(),
            p = f.scaleX < 0,
            d = 2e-5,
            m = 1e5,
            R = kt
              ? parseFloat(Z(t, Ot, i, !1, "0 0 0").split(" ")[2]) ||
                f.zOrigin ||
                0
              : 0,
            g = parseFloat(o.defaultTransformPerspective) || 0;
          if (
            ((f.svg = !(!t.getBBox || !It(t))),
            f.svg &&
              (Nt(
                t,
                Z(t, Ot, i, !1, "50% 50%") + "",
            ...
            if (16 === s.length) {
              ...
              f.zOrigin &&
                ...
                (f.scaleX = ((Math.sqrt(b * b + T * T) * m + 0.5) | 0) / m),
                (f.scaleY = ((Math.sqrt(k * k + E * E) * m + 0.5) | 0) / m),
                (f.scaleZ = ((Math.sqrt(C * C + M * M) * m + 0.5) | 0) / m),
                f.rotationX || f.rotationY
                  ? (f.skewX = 0)
                  : ((f.skewX =
                      O || k
                        ? Math.atan2(O, k) * F + f.rotation
                        : f.skewX || 0),
                    Math.abs(f.skewX) > 90 &&
                ...
                (f.z = L),
                f.svg &&
                  ((f.x -= f.xOrigin - (f.xOrigin * b - f.yOrigin * O)),
              ...
              (f.x = s[4] || 0),
                ...
                (l = Math.sqrt(Y * Y + V * V)),
                (u = Math.sqrt(U * U + B * B)),
                (h = Y || V ? Math.atan2(V, Y) * F : f.rotation || 0),
                (c = B || U ? Math.atan2(B, U) * F + h : f.skewX || 0),
                Math.abs(c) > 90 &&
                  Math.abs(c) < 270 &&
                  (p
                    ? ((l *= -1),
                ...
                kt &&
                  ...
                  (f.scaleZ = 1)),
                f.svg &&
                  ((f.x -= f.xOrigin - (f.xOrigin * Y + f.yOrigin * B)),
                  (f.y -= f.yOrigin - (f.xOrigin * V + f.yOrigin * U)));
            }
            f.zOrigin = R;
          ...
          if (f) {
            ...
            var p,
              ...
              v =
                ...
                ", M22=" +
                h,
              w = n.x + (R * n.xPercent) / 100,
              b = n.y + (g * n.yPercent) / 100;
            if (
              (null != n.ox &&
                ((p = (n.oxp ? R * n.ox * 0.01 : n.ox) - R / 2),
                (d = (n.oyp ? g * n.oy * 0.01 : n.oy) - g / 2),
                (w += p - (p * a + d * l)),
                (b += d - (p * u + d * h))),
              _
                ? ((p = R / 2),
              ...
              for (
                p = n.ieOffsetX || 0,
                  ...
                  n.ieOffsetX = Math.round(
                    (R - ((0 > a ? -a : a) * R + (0 > l ? -l : l) * g)) / 2 + w
                  ),
                  n.ieOffsetY = Math.round(
                    (g - ((0 > h ? -h : h) * g + (0 > u ? -u : u) * R)) / 2 + b
                  ),
                  vt = 0;
                4 > vt;
                vt++
                ...
                (z = it[vt]),
                  ...
                  (i =
                    -1 !== T.indexOf("px")
                      ? parseFloat(T)
                      : $(this.t, z, parseFloat(T), T.replace(y, "")) || 0),
                  (P =
                    i !== n[z]
                      ? 2 > vt
                        ? -n.ieOffsetX
          ...
          Y.setTransformRatio =
            function (t) {
                ...
                return void (O || z.skewX || L
                  ? ((O *= N),
                    ...
                    L &&
                      ((M +=
                        z.xOrigin -
                        (z.xOrigin * e + z.yOrigin * i) +
                        z.xOffset),
                      (F +=
                        z.yOrigin -
                        (z.xOrigin * r + z.yOrigin * s) +
                        z.yOffset),
                      bt &&
                        (z.xPercent || z.yPercent) &&
                        ((m = this.t.getBBox()),
                        (M += 0.01 * z.xPercent * m.width),
                        (F += 0.01 * z.yPercent * m.height)),
                      (m = 1e-6),
                      m > M && M > -m && (M = 0),
                      m > F && F > -m && (F = 0)),
                    (y =
              ...
              (u = 1),
                ...
                1 !== S && ((e *= S), (r *= S), (a *= S), (h *= S)),
                (d || L) &&
                  (d && ((M += n * -d), (F += o * -d), (I += u * -d + d)),
                  L &&
                    ((M +=
                      z.xOrigin - (z.xOrigin * e + z.yOrigin * i) + z.xOffset),
                    (F +=
                      z.yOrigin - (z.xOrigin * r + z.yOrigin * s) + z.yOffset)),
                  m > M && M > -m && (M = w),
                  m > F && F > -m && (F = w),
                  m > I && I > -m && (I = 0)),
                (y =
      ...
      (u = Ct.prototype),
          ...
          "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
          {
            parser: function (t, e, i, n, s, a, l) {
              ...
              var u,
                ...
                b = {},
                T = "transformOrigin",
                z = Xt(t, r, !0, l.parseTransform);
              if (((n._transform = z), "string" == typeof w.transform && zt))
                (h = X.style),
                  (h[zt] = w.transform),
                  (h.display = "block"),
                  (h.position = "absolute"),
                  L.body.appendChild(X),
                  (u = Xt(X, null, !1)),
                  z.svg &&
                    ((m = z.xOrigin),
                    (R = z.yOrigin),
                    ...
                    (w.transformOrigin || w.svgOrigin) &&
                      ...
                      (m = c.xOrigin),
                      (R = c.yOrigin),
                      (u.x -= c.xOffset - z.xOffset),
                      (u.y -= c.yOffset - z.yOffset)),
                    (m || R) &&
                      ((g = jt(X, !0)),
                      (u.x -= m - (m * g[0] + R * g[2])),
                      (u.y -= R - (m * g[1] + R * g[3])))),
                  L.body.removeChild(X),
                  u.perspective || (u.perspective = z.perspective),
                  null != w.xPercent &&
                    (u.xPercent = ot(w.xPercent, z.xPercent)),
                  null != w.yPercent &&
                    (u.yPercent = ot(w.yPercent, z.yPercent));
                ...
                if (
                  ...
                  if ("object" == typeof d) for (h in d) w[h] = d[h];
                  else w.rotation = d;
                "string" == typeof w.x &&
                  -1 !== w.x.indexOf("%") &&
                  ((u.x = 0), (u.xPercent = ot(w.x, z.xPercent))),
                  "string" == typeof w.y &&
                    -1 !== w.y.indexOf("%") &&
                    ((u.y = 0), (u.yPercent = ot(w.y, z.yPercent))),
                  (u.rotation = at(
                    "rotation" in w
                      ? w.rotation
                      : "shortRotation" in w
                  ...
                  (u.skewX = at(w.skewX, z.skewX - z.skewY)),
                  (u.skewY = at(w.skewY, z.skewY)) &&
                    ((u.skewX += u.skewY), (u.rotation += u.skewY));
              }
              for (
                kt && null != w.force3D && ((z.force3D = w.force3D), (p = !0)),
                  z.skewType = w.skewType || z.skewType || o.defaultSkewType,
                  f =
                    z.force3D ||
                    z.z ||
                    z.rotationX ||
                    ...
                    u.rotationY ||
                    u.perspective,
                  f || null == w.scale || (u.scaleZ = 1);
                --x > -1;

              )
                (i = Tt[x]),
                  (c = u[i] - z[i]),
                  (c > y || -y > c || null != w[i] || null != I[i]) &&
                    ((p = !0),
                    (s = new Rt(z, i, z[i], c, s)),
                    i in b && (s.e = b[i]),
                    (s.xs0 = 0),
                    (s.plugin = a),
              ...
              return (
                ...
                z.svg &&
                  ...
                  ((m = z.xOffset),
                  (R = z.yOffset),
                  Nt(t, rt(c), u, w.svgOrigin, w.smoothOrigin),
                  (s = gt(z, "xOrigin", (_ ? z : u).xOrigin, u.xOrigin, s, T)),
                  (s = gt(z, "yOrigin", (_ ? z : u).yOrigin, u.yOrigin, s, T)),
                  (m !== z.xOffset || R !== z.yOffset) &&
                    ((s = gt(z, "xOffset", _ ? m : z.xOffset, z.xOffset, s, T)),
                    (s = gt(z, "yOffset", _ ? R : z.yOffset, z.yOffset, s, T))),
                  (c = bt ? null : "0px 0px")),
                (c || (kt && f && z.zOrigin)) &&
                  (zt
                    ? ((p = !0),
                      ...
                      kt
                        ? ((h = z.zOrigin),
                          (c = c.split(" ")),
                          (z.zOrigin =
                            (c.length > 2 && (0 === h || "0px" !== c[2])
                              ? parseFloat(c[2])
                              : h) || 0),
                          (s.xs0 = s.e = c[0] + " " + (c[1] || "50%") + " 0px"),
                          (s = new Rt(z, "zOrigin", 0, 0, s, -1, s.n)),
                          (s.b = h),
                          (s.xs0 = s.e = z.zOrigin))
                        : (s.xs0 = s.e = c))
                    : rt(c + "", z)),
                p &&
                  (n._transformType =
                    (z.svg && bt) || (!f && 3 !== this._transformType) ? 2 : 3),
                s
              );
            },
            prefix: !0,
        ...
        xt("borderRadius", {
          ...
          parser: function (t, e, i, s, o, a) {
            ...
            for (
              ...
              this.p.indexOf("border") && (T[u] = H(T[u])),
                (f = c = Z(t, T[u], r, !1, "0px")),
                -1 !== f.indexOf(" ") &&
                ...
                _ !== v &&
                  ...
                  "%" === _
                    ...
                    : ((f = x + "px"), (c = w + "px")),
                  y &&
                    ((p = parseFloat(f) + m + _), (h = parseFloat(c) + m + _))),
                (o = _t(z, T[u], f + " " + c, p + " " + h, !1, "0px", o));
            return o;
          },
          prefix: !0,
        ...
        xt("backgroundPosition", {
          ...
          parser: function (t, e, i, n, s, o) {
            var a,
              ...
              g = this.format(e);
            if (
              (-1 !== R.indexOf("%")) != (-1 !== g.indexOf("%")) &&
              g.split(",").length < 2 &&
              ((f = Z(t, "backgroundImage").replace(O, "")), f && "none" !== f)
            ) {
              for (
                a = R.split(" "),
                  l = g.split(" "),
        ...
        xt("border", {
          ...
          parser: function (t, e, i, n, s, o) {
            ...
            return (
              "px" !== u &&
                (a = parseFloat(a) / $(t, "borderTopWidth", 1, u) + u),
              this.parseComplex(
                t.style,
                this.format(
                  a +
        ...
        parser: function (t, e, i, n, s, o) {
          ...
          return (
            ...
            u &&
              ...
              (a = 0),
            B
              ? (s = new Rt(l, "opacity", a, e - a, s))
              : ((s = new Rt(l, "opacity", 100 * a, 100 * (e - a), s)),
                (s.xn1 = u ? 1 : 0),
                (l.zoom = 1),
                (s.type = 2),
          ...
          e &&
            (t.removeProperty
              ? (("ms" === e.substr(0, 2) || "webkit" === e.substr(0, 6)) &&
                  (e = "-" + e),
                t.removeProperty(e.replace(z, "-$1").toLowerCase()))
              : t.removeAttribute(e));
        },
        Ut = function (t) {
      ...
      xt("className", {
        parser: function (t, e, n, s, o, a, l) {
          var u,
            ...
            m = t.style.cssText;
          if (
            ((o = s._classNamePT = new Rt(t, n, 0, 0, o, 2)),
            (o.setRatio = Ut),
            (o.pr = -11),
            (i = !0),
            (o.b = d),
        ...
        (u._onInitTween = function (t, e, a) {
          ...
          if (
            ...
            "string" == typeof e &&
              ...
              (b.cssText = R + ";" + e),
              (u = tt(t, u, J(t)).difs),
              !B && w.test(e) && (u.opacity = parseFloat(RegExp.$1)),
              (e = u),
              (b.cssText = R)),
            e.className
              ? (this._firstPT = p =
            ...
            for (
              ...
              m = m._next;
            (y = new Rt(t, "transform", 0, 0, null, 2)),
              this._linkCSSP(y, null, m),
              (y.setRatio = zt ? Yt : Dt),
              (y.data = this._transform || Xt(t, r, !0)),
              (y.tween = a),
              (y.pr = -1),
              s.pop();
          }
          if (i) {
            for (; p; ) {
              ...
              (p._prev = m ? m._prev : g) ? (p._prev._next = p) : (R = p),
                (p._next = m) ? (m._prev = p) : (g = p),
                (p = _);
            }
            this._firstPT = R;
          }
                  ...
                  (R && T.test(p))
                    ? (R ||
                        ...
                        (p =
                          ...
                          p.join(",") +
                          ")")),
                      (i = _t(_, o, f, p, !0, "transparent", i, 0, s)))
                    : R && M.test(p)
                    ? (i = _t(_, o, f, p, !0, null, i, 0, s))
                    : ((u = parseFloat(f)),
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  (function (t, e, i, n) {
    var r = i.body || i.documentElement,
      ...
      s = "",
      o = "";
    "" == r.WebkitAnimation && (s = "-webkit-"),
      "" == r.MozAnimation && (s = "-moz-"),
      "" == r.OAnimation && (s = "-o-"),
      "" == r.WebkitTransition && (o = "-webkit-"),
      "" == r.MozTransition && (o = "-moz-"),
      "" == r.OTransition && (o = "-o-"),
      t.fn.extend({
        ...
        onCSSTransitionEnd: function (e) {
          ...
          return (
            ...
            (("" != o || "transition" in r) &&
              "0s" != i.css(o + "transition-duration")) ||
              e(),
            this
          );
        },
  ...
  (function (t) {
    ...
    function r() {
      ...
      i.options.onUpdateSpeed && i.options.onUpdateSpeed.apply(e[0], [h]),
        (i._updateSpeedTimeout = setTimeout(function () {
          r.apply(e[0]);
    ...
    function s() {
      var e = t(this),
        i = e.data(u);
      (i._currSpeed = 0),
        (i._lastMousePosCalc = null),
        (i._currMousePosCalc = null),
        (i._hasAttachedMousemoveEvent = !1),
        i._updateSpeedTimeout && clearTimeout(i._updateSpeedTimeout);
    }
    function o() {
      var n = t(this),
        r = n.data(u);
      r._hasAttachedMousemoveEvent ||
        (n.one("mousemove." + u, function (t) {
          r._currMousePos && (r._lastMousePos = r._currMousePos);
          var s = t.pageX,
            a = t.pageY,
            l = new e(s, a);
          (r._currMousePos = new i(l, new Date().getTime())),
            setTimeout(function () {
              o.apply(n[0]);
            }, r.options.captureMouseMoveRate),
            (r._hasAttachedMousemoveEvent = !1);
        }),
    ...
    t.fn.cursometer = function (e) {
      return h[e]
        ...
        : "object" != typeof e && e
        ? void t.error("Method " + e + " does not exist on jQuery.cursometer")
      ...
      function (t, e, i) {
        ...
        var s = i(1),
          ...
          u = (function () {
            function t(e, i) {
              r(this, t),
                (this.options = (0, s.extend)(Object.create(l), i)),
                (this.elements = (0, s.getElements)(e).map(a["default"])),
                (this.running = !1);
            }
            return (
              (t.prototype.once = function () {
                var t = this;
                return (
                  (0, s.each)(this.elements, function (e) {
              ...
              (t.prototype.start = function () {
                ...
                return (
                  ...
                  (0, s.each)(this.elements, function (t) {
                    return t.init();
                  }),
              ...
              (t.prototype.text = function (t) {
                var e = this;
                return (
                  (0, s.each)(this.elements, function (i) {
                    ...
                    clearInterval(t.interval),
                      ...
                      (t.interval = setInterval(function () {
                        ...
                        (0, s.each)(e, function (e) {
                          ...
                          e.length ||
                            (t.stop(),
                            (0, s.each)(t.elements, function (t) {
                              return t.init();
                            }));
                      }, t.options.speed));
                  };
                ...
                var t = this,
                  ...
                  i =
                    arguments.length <= 1 || void 0 === arguments[1]
                      ...
                      : arguments[1];
                return e.length
                  ? (0, o.mapString)(this.value, function (n, r) {
    ...
    return (function (t) {
        ...
        var r = i(8),
          ...
          l = (e.inViewport = function (t) {
            ...
            return (
              s > e &&
              r > e &&
              window.innerWidth - o > e &&
              window.innerHeight - n > e
            );
          }),
          u = function () {
            var t = 100,
              ...
              if ("string" == typeof t) {
                ...
                return (
                  n.history.indexOf(t) > -1
                    ? (n[t].elements = e)
                    : ((n[t] = (0, a["default"])(e)), n.history.push(t)),
                  n[t]
                );
              }
            };
                  ...
                  value: function (t) {
                    ...
                    return (
                      this.elements.forEach(function (i) {
                        var n = (0, s.inViewport)(i, t),
                          r = e.current.indexOf(i),
                          o = r > -1,
                          a = n && !o,
                          l = !n && o;
                        a && (e.current.push(i), e.emit("enter", i)),
                          l && (e.current.splice(r, 1), e.emit("exit", i));
                      }),
                      this
                    );
                  },
      ...
      function (t, e, i) {
        function n(t, e, i) {
          ...
          function d(t) {
            return (w = void 0), O && _ ? n(t) : ((_ = v = void 0), x);
          }
          function m() {
  ...
  !(function (t, e) {
    function i(i) {
      ...
      if (i.constructor === String && ((i = e.getElementById(i)), !i))
        throw new Error(
    ...
    (i.prototype.TYPES = [
      ...
      (i.prototype.scan = function (t) {
        for (
          var e, i, n, r, s = t.querySelectorAll(this.TYPES.join(",")), o = 0;
          o < s.length;
          o++
        )
          (i = s[o]),
      ...
      (i.prototype.pathMaker = function (t, i) {
        var n,
          r,
          s = e.createElementNS("http://www.w3.org/2000/svg", "path");
        for (n = 0; n < t.attributes.length; n++)
          (r = t.attributes[n]),
            -1 === this.ATTR_WATCH.indexOf(r.name) &&
              s.setAttribute(r.name, r.value);
    ...
    (n.LINEAR = function (t) {
              ...
              (s = function (t) {
                if (!o.isReady) {
                  if (
                    ((o.el =
                      i.contentDocument &&
                      i.contentDocument.querySelector("svg")),
                    !o.el && t)
                  )
                    throw new Error(
                  ...
                  return o.el
                    ? (i.getAttribute("built-by-vivus") &&
                        (o.parentEl.insertBefore(o.el, i),
      ...
      (n.prototype.setOptions = function (e) {
        ...
        if (((e = e || {}), e.type && -1 === i.indexOf(e.type)))
          throw new Error(
            "Vivus [constructor]: " +
              e.type +
        ...
        if (
          ((this.type = e.type || i[0]), e.start && -1 === r.indexOf(e.start))
        )
          throw new Error(
            "Vivus [constructor]: " +
              e.start +
      ...
      (n.prototype.mapping = function () {
        var e, i, n, r, s, a, l, u;
        for (
          u = a = l = 0, i = this.el.querySelectorAll("path"), e = 0;
          e < i.length;
          e++
        )
          (n = i[e]),
        ...
        for (
          ...
          switch (((s = this.map[e]), this.type)) {
            ...
            case "scenario-sync":
              (n = s.el),
                (r = this.parseAttr(n)),
                (s.startAt = u + (o(r["data-delay"], this.delayUnit) || 0)),
            ...
            var e = this,
              i = function () {
                e.isInViewport(e.parentEl, 1) &&
                  (e.play(), t.removeEventListener("scroll", i));
              };
      ...
      (n.prototype.parseAttr = function (t) {
        ...
        if (t && t.attributes)
          for (var n = 0; n < t.attributes.length; n++)
            (e = t.attributes[n]), (i[e.name] = e.value);
        return i;
      }),
...
var Util = (function (t) {
    ...
    var e = t(".main-navigation"),
      ...
      a = function () {
        t(document).on("click", ".close-contact", function (e) {
          e.preventDefault(),
            t("body").removeClass("is-contact-open"),
            setTimeout(function () {
      ...
      u = function () {
        var e = t(document).find("title").text(),
          i = "Be sure to checkout this before closing the internet";
  ...
  Navigation = (function (t) {
    ...
    var e = function () {
        ...
        function i(t) {
          s - t > o
            ? (n.removeClass("is-hidden").addClass("view-in-scroll"),
              t < 20 && n.removeClass("view-in-scroll"))
            : t - s > o && t > a && n.addClass("is-hidden");
        }
      ...
      n = function () {
        var e = t(".no-single-work"),
          i = t(".in-single-work");
        t(".single-work").length || t(".privacy").length
          ? (e.addClass("hidden"), i.addClass("not-hidden"))
          : (e.removeClass("hidden"), i.removeClass("not-hidden"));
      },
      r = function (t) {
        var e = t.find(".no-single-work"),
          i = t.find(".in-single-work");
        t.find(".single-work").length
          ? (e.addClass("hidden"), i.addClass("not-hidden"))
          : (e.removeClass("hidden"), i.removeClass("not-hidden"));
      },
      s = function () {
  ...
  Cookie = (function (t) {
    ...
    var e = t(".cookie-banner"),
      ...
      n = function (t, e, i) {
        ...
        document.cookie =
          encodeURIComponent(t) + "=" + encodeURIComponent(e) + n + "; path=/";
      },
      r = function (t) {
        for (
    ...
    var e = function (e) {
      ...
      i = function () {
        t(document).on("click", "#change-theme", function (e) {
          e.preventDefault(),
            t("body").hasClass("bright-theme")
              ? (t("body").removeClass("bright-theme"),
                Cookie.create("theme", "default", 30))
              : (t("body").addClass("bright-theme"),
                Cookie.create("theme", "bright", 30));
        });
      },
      n = function () {
        "bright" == Cookie.read("theme") && t(".main-hero").length
          ? t("body").addClass("bright-theme")
          : t("body").removeClass("bright-theme");
      },
      r = function () {
      ...
      o = function () {
        ...
        e.length &&
          ...
          Modernizr.mq("(min-width: 1024px)") &&
            window
              .baffle(document.querySelectorAll(".stripe-baffle"), {
                characters: "█▓▒░█▓▒░█▓▒░<>/",
              })
              .start()
              .reveal(1e3, 800));
      ...
      p = function (e, n) {
        function l() {
          null != Cookie.read("banner")
            ? p.removeClass("is-banner-open")
            : setTimeout(function () {
            ...
            TweenLite.to(h, 1, {
              ...
              onComplete: function () {
                Util.init(),
                  ...
                  i(),
                  t(".main-hero").length &&
                    AnimationManager.animateHeroShapes(),
                  u(),
                  r(),
                  a(),
                  s(),
      ...
      d = function () {
        ...
        var i,
          ...
          s = 2,
          o = 13,
          a = document.querySelector(".main-hero");
        a.addEventListener("mousemove", t, !1);
      },
      m = function () {
        Modernizr.mq("(min-width: 1024px)") &&
          t(".about-contact").cursometer({
...
// Restricting Zoom via JavaScript (Enhanced for All Browsers)
document.addEventListener("keydown", function (event) {
  // Preventing zoom with Ctrl + or Ctrl -
  if (
    ...
    console.log("Zoom prevented via keyboard.");
  }
});

// Preventing Zoom with Ctrl + Scroll (Mouse)
document.addEventListener(
  "wheel",
  function (event) {
    if (event.ctrlKey) {
      event.preventDefault();
      console.log("Zoom prevented via scroll.");
    }
  },
  { passive: false }
);

// Preventing Zoom on Touch Devices (Pinch Zoom)
document.addEventListener(
  "touchstart",
  function (event) {
    if (event.touches.length > 1) {
      event.preventDefault();
      console.log("Zoom prevented via touch.");
    }
  },
  { passive: false }
);
...
// Blocking Developer Tools and View Source
document.addEventListener("keydown", function (event) {
...
document.addEventListener("keydown", function (event) {
  // Block Ctrl + Shift + R (Screen Recording)
...
document.addEventListener("keydown", function (event) {
  // Block Ctrl + Shift + S (Screen Sharing)
